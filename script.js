...
// Основные узлы приложения: список историй и отдельный режим чтения.
...
// Режим чтения строит вертикальные экраны-слайды для выбранной истории.
      ...
      return `
        ...
        >
          ...
          <div class="slide-card with-illustration">
            <span class="slide-kicker">${index + 1} из ${story.slides.length}</span>
            <img
...
// Прогресс считается по прокрутке контейнера со слайдами, а не всей страницы.
